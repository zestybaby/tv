...
(function(t, e) {
    (function(n, i) {
        ...
        var ct = {
            ...
            bt = function(o, C) {
                return o.replace(/@ui\.[a-zA-Z/u2E80-/u9FFF-_$0-9]*/g, function(O) {
                    return C[O.slice(4)]
                })
            },
            Kt = function y(o, C, O) {
...
(function(t, e) {
    (function(n, i) {
        ...
        var V = D,
            ...
            G = /^[A-Z/u2E80-/u9FFFa-z][A-Z/u2E80-/u9FFFa-z0-9+-.]*:\/\//,
            Q = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i,
...
const Gx = VC.extend({
    ...
    sanitize(t) {
        return t.replace(/[^A-Z/u2E80-/u9FFF0-9\u00A1\u0020-\u002F\u00BF-\u00FF!?*$+\-’'_ .,:]/gi, "").replace(/'/g, "\u2019").trim()
    },
    onResize() {
        const t = se(window).width(),
