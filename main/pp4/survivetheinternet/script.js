...
(function(t, e) {
    (function(n, i) {
        ...
        var ct = {
            ...
            bt = function(o, C) {
                return o.replace(/@ui\.[a-zA-Z/u2E80-/u9FFF-_$0-9]*/g, function(A) {
                    return C[A.slice(4)]
                })
            },
            Kt = function y(o, C, A) {
...
(function(t, e) {
    (function(n, i) {
        ...
        var $ = D,
            ...
            Y = /^[A-Z/u2E80-/u9FFFa-z][A-Z/u2E80-/u9FFFa-z0-9+-.]*:\/\//,
            re = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i,
...
`,
        ...
        var ys = {
            email: (c, h) => /^[a-zA-Z/u2E80-/u9FFF0-9.+_-]+@[a-zA-Z/u2E80-/u9FFF0-9.-]+\.[a-zA-Z/u2E80-/u9FFF0-9-]{2,24}$/.test(c) ? Promise.resolve() : Promise.resolve(h || "Invalid email address"),
            url: (c, h) => /^https?:\/\/(www\.)?[-a-zA-Z/u2E80-/u9FFF0-9@:%._+~#=]{1,256}\.[a-z]{2,63}\b([-a-zA-Z/u2E80-/u9FFF0-9@:%_+.~#?&/=]*)$/.test(c) ? Promise.resolve() : Promise.resolve(h || "Invalid URL")
        };
...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("main/pp4/survivetheinternet/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="main/pp4/survivetheinternet/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
        ...
        bindings: {
            ...
            ".voteThumbnail": {
                ...
                attributes: [{
                    ...
                    observe: "thumbnail",
                    onGet(t) {
                        const n = (t || "").match(/images\/survivetheinternet\/photos\/([a-zA-Z/u2E80-/u9FFF]+-thumb)\.jpg/);
                        return n ? n[1] : ""
                    }
                }, {
                    name: "aria-label",
...
const Qx = Fx.extend({
    ...
    parseBlob(t) {
        if (t.playerInfo = t.playerInfo || {}, t.playerInfo.username = t.playerName || "Audience", t.playerInfo.color && (t.playerInfo.avatar = t.playerInfo.color.frame, t.playerInfo.topBarColor = t.playerInfo.color.dark.hexString, t.playerInfo.bgColor = t.playerInfo.color.veryLight.hexString, t.playerInfo.textColor = t.playerInfo.color.veryLight.hexString, t.playerInfo.buttonColor = t.playerInfo.color.dark.hexString), t.state === "Gameplay" && (t.state = "Logo"), t.state === "Lobby" && (this.client.isRole("player") || (t.state = "Logo"), t.playerIsVIP = t.isAllowedToStartGame, t.playerCanStartGame = t.isAllowedToStartGame, t.playerCanCensor = t.canCensor, t.gameCanStart = ["CanStart", "Countdown", "PostGame"].indexOf(t.lobbyState) !== -1, t.gameIsStarting = t.lobbyState === "Countdown", t.gameFinished = t.lobbyState === "PostGame"), t.censorablePlayers && delete t.censorablePlayers, t.state === "EnterSingleText" && t.text && t.text.aboveBlackBox) {
            const e = t.text.aboveBlackBox.match(/images\/survivetheinternet\/photos\/([a-zA-Z/u2E80-/u9FFF]+)\.jpg/);
            if (e) {
                const n = e[1],
                    i = this.altTexts[n];
        ...
        if (t.state === "Voting" && (t.choices = t.choices.map(e => {
                ...
                const n = e.thumbnail.match(/images\/survivetheinternet\/photos\/([a-zA-Z/u2E80-/u9FFF]+)-thumb\.jpg/);
                if (n) {
            ...
            const e = t.text.blackBox.match(/(.*)<img src='images\/survivetheinternet\/photos\/([a-zA-Z/u2E80-/u9FFF]+)\.jpg'\/>(.*)/);
            if (e) {
                const n = e[2],
                    i = this.altTexts[n];
