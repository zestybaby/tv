...
class Ot {
    ...
    static async showError(e) {
        const n = new URL("main/pp6/rolemodels/assets/8cdd50e7.png", self.location).href,
            i = e.customClass || {};
        return e.customClass = {
            ...i,
            popup: "jbgModal"
...
<div style="display:none;">\r
    ...
    <li class="pull-left button-pad">\r
        <button id="undoButton" class="undo button">\r
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 64 64"><image x="12" y="20" width="41" height="39" xlink:href="main/pp6/rolemodels/assets/5f12600b.png"/></svg>\r
        </button>\r
    </li>\r
    <li class="pull-left button-pad"> \r
...
<div style="display:none;">\r
    <img id="Mask" src='main/pp6/rolemodels/rolemodels/oval.png' />\r
</div>`,
    Hx = Zu.extend({
