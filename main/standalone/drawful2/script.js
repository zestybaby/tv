...
(function(t, e) {
    (function(n, i) {
        ...
        var ct = {
            ...
            bt = function(a, C) {
                return a.replace(/@ui\.[a-zA-Z/u2E80-/u9FFF-_$0-9]*/g, function(A) {
                    return C[A.slice(4)]
                })
            },
            Jt = function y(a, C, A) {
...
(function(t, e) {
    (function(n, i) {
        ...
        var $ = L,
            ...
            W = /^[A-Z/u2E80-/u9FFFa-z][A-Z/u2E80-/u9FFFa-z0-9+-.]*:\/\//,
            re = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i,
...
`,
        ...
        var ys = {
            email: (u, d) => /^[a-zA-Z/u2E80-/u9FFF0-9.+_-]+@[a-zA-Z/u2E80-/u9FFF0-9.-]+\.[a-zA-Z/u2E80-/u9FFF0-9-]{2,24}$/.test(u) ? Promise.resolve() : Promise.resolve(d || "Invalid email address"),
            url: (u, d) => /^https?:\/\/(www\.)?[-a-zA-Z/u2E80-/u9FFF0-9@:%._+~#=]{1,256}\.[a-z]{2,63}\b([-a-zA-Z/u2E80-/u9FFF0-9@:%_+.~#?&/=]*)$/.test(u) ? Promise.resolve() : Promise.resolve(d || "Invalid URL")
        };
...
const Hx = VC.extend({
    ...
    lobbyUgcSubmit() {
        ...
        return t = t.replace(/[^A-Z/u2E80-/u9FFFa-z]/gi, ""), t = t.toUpperCase(), this.activateContentId(t), !1
    },
    lobbyUgcHistory(t) {
    ...
    sanitize(t) {
        return t = t.replace(/[^A-Z/u2E80-/u9FFF0-9\u00A1\u0020-\u002F\u00BF-\u00FF!?*$+\-’'_ .,=<>]/gi, "").replace(/'/g, "\u2019").trim(), Rt.htmlEscape(t)
    },
    validateInput(t) {
        const e = j(t.target);
        let n = e.val();
